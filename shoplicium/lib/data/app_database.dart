...
abstract class DbHelper {
  ...
  static const createListTableCommand =
      'CREATE TABLE ShoppingLists(listId TEXT PRIMARY KEY, title TEXT, date TEXT, createdOn TEXT)';
  static const createListItemsTableCommand =
      'CREATE TABLE ListItems(itemId TEXT PRIMARY KEY, title TEXT, amount INTEGER, UOM INTEGER, status INTEGER, listId TEXT, FOREIGN KEY(listId) REFERENCES ShoppingLists(listId))';
}
